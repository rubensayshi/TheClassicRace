--[[
AceSerializer-3.0-Roobs is an adjusted version of AceSerializer-3.0
that adds a patch to serialize array-like tables more optimally
]]--
...
local MAJOR,MINOR = "AceSerializer-3.0-TCR", 5
